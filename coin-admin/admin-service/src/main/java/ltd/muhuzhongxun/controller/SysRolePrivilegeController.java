...
import ltd.muhuzhongxun.service.SysRolePrivilegeService;
...
public class SysRolePrivilegeController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "roleId" ,value = "角色的ID", dataTypeClass = String.class)
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "rolePrivilegesParam" ,value = "rolePrivilegesParam json数", dataTypeClass = String.class)
    })
