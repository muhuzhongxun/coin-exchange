...
import ltd.muhuzhongxun.service.SysPrivilegeService;
...
public class SysPrivilegeController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "size" ,value = "每页显示的大小", dataTypeClass = String.class) ,
    })
...
//  orderitem失效，改用wrapper      page.addOrder(OrderItem.desc("last-update-time"), OrderItem.asc("id")) ;
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "sysPrivilege" ,value = "sysPrivilege 的json数据",dataTypeClass = String.class)
    })
    public R add(@RequestBody @Validated SysPrivilege sysPrivilege){
        // 新增时，我们需要给我们的新增对象填充一些属性
//        已在Sysprivilege实体添加自动填充注解。具体看common-》AutoFillHandler
