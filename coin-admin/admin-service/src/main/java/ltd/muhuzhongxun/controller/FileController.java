...
public class FileController{
    ...
    @Value("${oss.bucket.name:coin-exchange-muhuzhongxun-image}")
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "file" ,value = "你要上传的文件", dataTypeClass = String.class)
    })
    public R<String> fileUpload(@RequestParam("file") MultipartFile file) throws IOException {
        ...
        // 上传成功后，路径为https://coin-exchange-muhuzhongxun-image.oss-cn-hangzhou.aliyuncs.com/2020/10/10/1588586643_meitu_1.jpg
