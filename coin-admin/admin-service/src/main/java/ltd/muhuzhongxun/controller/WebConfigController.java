...
public class WebConfigController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "name",value = "webConfig的名称", dataTypeClass = String.class) ,
            @ApiImplicitParam(name = "type",value = "webConfig的类型", dataTypeClass = String.class) , // nteger current ,Integer siz
            @ApiImplicitParam(name = "current",value = "当前页", dataTypeClass = String.class) ,
            @ApiImplicitParam(name = "size",value = "每页的大小", dataTypeClass = String.class) ,
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "webConfig" ,value = "webConfig 的json数据", dataTypeClass = String.class)
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "ids" ,value = "要删除的数据的ids", dataTypeClass = String.class)
    })
