...
public class ConfigController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "type" ,value = "后台参数类型", dataTypeClass = String.class),
            @ApiImplicitParam(name = "code" ,value = "后台参数code", dataTypeClass = String.class),
            @ApiImplicitParam(name = "name" ,value = "后台参数名称", dataTypeClass = String.class),
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "config",value = "config 的json数据", dataTypeClass = String.class)
    })
