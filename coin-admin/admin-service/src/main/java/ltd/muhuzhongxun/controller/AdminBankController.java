...
import ltd.muhuzhongxun.domain.AdminBank;
import ltd.muhuzhongxun.model.R;
import ltd.muhuzhongxun.service.AdminBankService;
...
public class AdminBankController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "bankCard" ,value = "公司的银行卡", dataTypeClass = String.class) ,
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "adminBank" ,value = "adminBank json数据", dataTypeClass = String.class)
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "bankId" ,value = "要修改的银行卡的ID", dataTypeClass = String.class),
            @ApiImplicitParam(name = "status" ,value = "要修改为的状态", dataTypeClass = String.class)
    })
    @PreAuthorize("hasAuthority('admin_bank_update')")
